          ...
          >
            ...
            <div className="mt-5">
              <p className="text-white mt-5 md:mt-3 md:leading-[28px] gilory-regular md:text-[1.375rem]">
                Today, the preparation of human salespeople isno longer
                sufficient; their motivation fluctuates, and their extremely
                variableefficiency in communication is insufficient in the
                advertisement noisegenerated by your competitors, which has
                become immense, your potentialcustomers most likely don't even
                hear it.
              </p>

              <p className="text-white mt-5 md:mt-3  md:leading-[28px] gilory-regular md:text-[1.375rem]">
                Artificial Intelligence might seem like asolution at first
                thought, but there are two insurmountable factors. 
              </p>

              <p className="text-white mt-5 md:mt-3  md:leading-[28px] gilory-regular  md:text-[1.375rem]">
                Artificial Intelligence performs excellentlyin many areas, but
                sales is an infinitely complex activity, explicitlyrequiring
                emotions. People will always buy from companies, during a
                purchase,people give their money for the product or service.
                Right? However, peopleALWAYS buy from people!
              </p>
            </div>
          </motion.div>
        </div>
